...
class MainLogic:
    ...
    def __init__(self, exodusFilePath, bitgetFilePath, bitpayFilePath, tokenpocketFilePath, enjinFilePath, defiFilePath):
        ...
        self.exodusFilePath = exodusFilePath
        self.bitgetFilePath = bitgetFilePath
        self.bitpayFilePath = bitpayFilePath
        self.tokenpocketFilePath = tokenpocketFilePath
        self.enjinFilePath = enjinFilePath
        self.defiFilePath = defiFilePath
        
        print(exodusFilePath)
        print(bitgetFilePath)
        print(bitpayFilePath)
        print(tokenpocketFilePath)
        print(enjinFilePath)
        print(defiFilePath)
